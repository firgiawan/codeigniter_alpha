							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									...
									<ul class="nav navbar-nav navbar-right">
										<li class="active"><a href="<?php echo site_url('kategori/create') ?>">Create</a></li>
									</ul>
								</div><!-- /.navbar-collapse -->
						</div>
						</nav>
								...
								<?php foreach ($kategori_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('kategori/delete/').$key->id ?>" type="button" class="btn btn-success">Delete</a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
